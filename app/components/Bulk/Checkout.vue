<template>
  <v-app class="bg-black">
    <v-main>
      <v-container class="fill-height d-flex flex-column align-center justify-center py-10">
        ...
        <div class="text-center mb-8 text-white">
          ...
          <p class="text-body-2 text-grey-lighten-1" style="max-width: 600px; margin: 0 auto; line-height: 1.6;">
            অর্ডার করতে নিচের ফর্মে আপনার নাম, পূর্ণ ঠিকানা এবং মোবাইল নাম্বার লিখুন। তারপর নিচে Place order বাটনে ক্লিক করে আপনার অর্ডারটি সম্পন্ন করুন।
          </p>
        </div>

        <!-- Main Form Card with Gradient Border -->
        <div class="gradient-border-wrapper">
          <v-card class="pa-6 pa-md-8 rounded-lg" flat color="white" width="100%" max-width="900">
            
            <v-form ref="formRef" @submit.prevent="handlePlaceOrder">
              <!-- Contact Information -->
              <h3 class="text-h6 text-grey-darken-3 mb-4">Contact Information</h3>
                  ...
                  <v-radio value="free" color="primary">
                    <template v-slot:label>
                      <div class="d-flex align-center w-100">
                        <span class="text-body-1 text-black">Free shipping</span>
                      </div>
                    </template>
                  </v-radio>
                </v-radio-group>
              ...
              <div class="d-flex flex-column flex-sm-row align-center mb-4">
                <div class="d-flex align-center flex-grow-1 w-100">
                  ...
                  <div class="flex-grow-1">
                    <div class="font-weight-bold text-body-1 mb-2">Micodus Tracker</div>
                    ...
                    <div class="d-flex align-center">
                      ...
                      <input 
                        ...
                        style="width: 40px; height: 24px; font-size: 12px; outline: none; border-color: rgba(0,0,0,0.12);"
              ...
              <div class="d-flex justify-space-between mb-6 font-weight-bold text-h6">
                <span>Total</span>
...
const handlePlaceOrder = async () => {
  ...
  try {
    ...
    if (response.success) {
      alertMessage.value = 'Order placed successfully! We will contact you soon.'
    ...
    alertMessage.value = error.data?.message || 'Failed to place order. Please try again.'
    alertType.value = 'error'
  } finally {
